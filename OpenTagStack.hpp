...
#ifndef PROJECT1_PHASE2_STUDENT_FILES_OPENTAGSTACK_HPP
#define PROJECT1_PHASE2_STUDENT_FILES_OPENTAGSTACK_HPP
...
class OpenTagStack {
public:
    bool isInStack(string tagName); // returns true if the tagName is in the stack.
    ...
    void removeElementWithTagName(string tagName);
    void printStack(); // Use this function as a debugging tool to print all tokens that
                       // are currently on the stack.

    // printTokensAbove is used when the token that is at the top of the stack
    ...
    void printTokensAbove(string tagName);
...
#endif //PROJECT1_PHASE2_STUDENT_FILES_OPENTAGSTACK_HPP
